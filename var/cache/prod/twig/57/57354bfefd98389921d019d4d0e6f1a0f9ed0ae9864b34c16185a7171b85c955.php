...
class __TwigTemplate_b239da77e7e27465c4976b0cfb240c34b53c67179926fe05956e6c431fb17376 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 12), "bookings", [], "any", false, false, false, 12));
        $context['loop'] = [
        ...
        <div class=\"col-4\">
            ...
            <div class=\"mt-3\">
                ";
            // line 17
            $context["comment"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["booking"], "ad", [], "any", false, false, false, 17), "commentFromAuthor", [0 => twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 17)], "method", false, false, false, 17);
            // line 18
            echo "                ";
            if ( !(null === ($context["comment"] ?? null))) {
                // line 19
                echo "                    <strong>Note donnée : </strong> ";
                $this->loadTemplate("partials/rating.html.twig", "account/bookings.html.twig", 19)->display(twig_array_merge($context, ["rating" => twig_get_attribute($this->env, $this->source, ($context["comment"] ?? null), "rating", [], "any", false, false, false, 19)]));
                // line 20
                echo "                ";
            } else {
                // line 21
...
";
    ...
    {
        return array (  157 => 38,  139 => 34,  133 => 31,  127 => 30,  123 => 29,  118 => 27,  113 => 24,  108 => 22,  105 => 21,  102 => 20,  99 => 19,  96 => 18,  94 => 17,  87 => 15,  83 => 13,  66 => 12,  58 => 6,  54 => 5,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "account/bookings.html.twig", "/Applications/MAMP/htdocs/lineup/templates/account/bookings.html.twig");
    }
}
