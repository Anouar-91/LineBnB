...
/* ad/_ad.html.twig */
class __TwigTemplate_3925507a1ea69898e9411b74f67c3cb5dbddb94dd1770b0c1cf607342eff136f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card bg-light mb-3\">
        ...
        echo "€</strong><br>
            ";
        // line 7
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["ad"] ?? null), "comments", [], "any", false, false, false, 7)) > 0)) {
            // line 8
            echo "                ";
        ...
        echo "\">En savoir plus !</a>
            ";
        // line 27
        if ((twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 27) && (twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 27) == twig_get_attribute($this->env, $this->source, ($context["ad"] ?? null), "author", [], "any", false, false, false, 27)))) {
            // line 28
            echo "            <a href=\"";
