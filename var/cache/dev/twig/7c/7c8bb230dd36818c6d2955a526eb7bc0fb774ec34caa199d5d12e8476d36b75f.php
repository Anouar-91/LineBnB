...
class __TwigTemplate_d61958fbd356b0bbae046cdfd8613d534fda650a6d074a8c7f83e36f168cfbaa extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  136 => 41,  131 => 29,  124 => 25,  121 => 24,  113 => 21,  110 => 20,  108 => 19,  105 => 18,  101 => 16,  99 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"col-md-6\">
            <div class=\"bg-light py-3 px-3\">
                ...
                <form method=\"post\">
                    ...
                    {% if app.user %}
                        <div class=\"mb-3\">
                            Vous êtes connecté en tant que <strong>{{ app.user.username }},</strong> <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
                        </div>
                    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/Applications/MAMP/htdocs/lineup/templates/security/login.html.twig");
    }
}
