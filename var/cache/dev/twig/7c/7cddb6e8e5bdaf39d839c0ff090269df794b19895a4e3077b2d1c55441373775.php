...
class __TwigTemplate_108641068e30a313727a1c10c6c934eaa20aae3cdac44307b455207fdfe62e2d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
       ...
       <div class=\"row\">
        ...
        echo "
                   ";
        // line 18
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "picture", [], "any", false, false, false, 18), 'row');
        echo "
           ...
           <div class=\"col\">
                <div class=\"alert alert-light\">
                   ...
                   ";
        // line 26
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 26, $this->source); })()), "introduction", [], "any", false, false, false, 26), 'row');
        echo "
                   ";
        // line 27
...
";
    ...
    {
        return array (  141 => 39,  126 => 27,  122 => 26,  111 => 18,  107 => 17,  103 => 16,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Modification du profile utilisateur{% endblock %}
...
{% endblock %}", "account/profile.html.twig", "/Applications/MAMP/htdocs/lineup/templates/account/profile.html.twig");
    }
}
