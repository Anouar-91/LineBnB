...
/* ad/show.html.twig */
class __TwigTemplate_c7e5b4130bddb75a5b19aa14a0b1f2778eaf1802de5409f49043e7bbb1fcc077 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"ad-title\" style=\"background-image : url(";
        ...
        echo "\" class=\"btn btn-primary\">Réserver !</a>
            ...
            ";
        // line 18
        if ((twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 18, $this->source); })()), "user", [], "any", false, false, false, 18) && (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 18, $this->source); })()), "user", [], "any", false, false, false, 18) == twig_get_attribute($this->env, $this->source, (isset($context["ad"]) || array_key_exists("ad", $context) ? $context["ad"] : (function () { throw new RuntimeError('Variable "ad" does not exist.', 18, $this->source); })()), "author", [], "any", false, false, false, 18)))) {
            // line 19
            echo "            <a href=\"";
    ...
    <div class=\"container\">
       <div class=\"row\">
        ...
        echo "                </div>
                ...
                ";
        // line 59
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["ad"]) || array_key_exists("ad", $context) ? $context["ad"] : (function () { throw new RuntimeError('Variable "ad" does not exist.', 59, $this->source); })()), "comments", [], "any", false, false, false, 59)) > 0)) {
            // line 60
...
{% endblock %}", "ad/show.html.twig", "/Applications/MAMP/htdocs/lineup/templates/ad/show.html.twig");
    }
}
