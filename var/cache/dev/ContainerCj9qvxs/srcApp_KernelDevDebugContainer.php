...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder59ae8 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer45ed6 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties685d0 = [
        
    ];

    public function getConnection()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getConnection', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getMetadataFactory', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getExpressionBuilder', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'beginTransaction', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getCache', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getCache();
    }

    public function transactional($func)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'transactional', array('func' => $func), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->transactional($func);
    }

    public function commit()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'commit', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->commit();
    }

    public function rollback()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'rollback', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getClassMetadata', array('className' => $className), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'createQuery', array('dql' => $dql), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'createNamedQuery', array('name' => $name), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'createQueryBuilder', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'flush', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'clear', array('entityName' => $entityName), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->clear($entityName);
    }

    public function close()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'close', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->close();
    }

    public function persist($entity)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'persist', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'remove', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'refresh', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'detach', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'merge', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getRepository', array('entityName' => $entityName), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'contains', array('entity' => $entity), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getEventManager', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getConfiguration', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'isOpen', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getUnitOfWork', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getProxyFactory', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'initializeObject', array('obj' => $obj), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'getFilters', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'isFiltersStateClean', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'hasFilters', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return $this->valueHolder59ae8->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer45ed6 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder59ae8) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder59ae8 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder59ae8->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, '__get', ['name' => $name], $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        if (isset(self::$publicProperties685d0[$name])) {
            return $this->valueHolder59ae8->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59ae8;
    ...
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;
    ...
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, '__isset', array('name' => $name), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;
    ...
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, '__unset', array('name' => $name), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;
    ...
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, '__clone', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        $this->valueHolder59ae8 = clone $this->valueHolder59ae8;
    }

    public function __sleep()
    {
        $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, '__sleep', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;

        return array('valueHolder59ae8');
    }
    ...
    {
        $this->initializer45ed6 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer45ed6;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer45ed6 && ($this->initializer45ed6->__invoke($valueHolder59ae8, $this, 'initializeProxy', array(), $this->initializer45ed6) || 1) && $this->valueHolder59ae8 = $valueHolder59ae8;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder59ae8;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder59ae8;
    }
